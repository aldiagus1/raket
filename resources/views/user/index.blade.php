                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="card racket-card h-100 shadow-sm">
                        <div class="racket-img-container">
                            <span class="badge badge-brand">{{ $raket->brand }}</span>
                            @if($raket->gambar)
                                <img src="{{ asset('storage/' . $raket->gambar) }}" class="racket-img" alt="{{ $raket->nama_raket }}">
                            @else
                        ...
                        <div class="card-body d-flex flex-column justify-content-between p-4">
                            <div>
                                <h5 class="fw-bold text-dark text-truncate mb-1">{{ $raket->nama_raket }}</h5>
                            ...
                            <a href="{{ route('user.show', $raket->id) }}" class="btn btn-primary btn-detail w-100 py-2">
                                <i></i>Lihat Produk
                            </a>
                        </div>
                    </div>

...
<head>
    ...
    <title><?php echo e($raket->nama_raket); ?> - Detail Analisis</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top shadow-sm py-3">
        <div class="container">
            <a class="navbar-brand text-primary fw-bold" href="<?php echo e(route('user.index')); ?>">🏸 SMASH<span class="text-white">ZONE</span></a>
            <a href="<?php echo e(route('user.index')); ?>" class="btn btn-outline-light btn-sm" style="border-radius: 8px;"><i class="fa-solid fa-arrow-left me-1"></i> Kembali ke Katalog</a>
        </div>
    </nav>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-5">
                    <div class="img-display-container shadow-sm">
                        <?php if($raket->gambar): ?>
                            <img src="<?php echo e(asset('storage/' . $raket->gambar)); ?>" class="img-display" alt="<?php echo e($raket->nama_raket); ?>">
                        <?php else: ?>
                ...
                <div class="col-lg-7">
                    <div class="mb-3">
                        <span class="badge badge-brand mb-2"><?php echo e($raket->brand); ?></span>
                        <h2 class="fw-bold text-dark mb-1"><?php echo e($raket->nama_raket); ?></h2>
                    </div>

                    <h5 class="fw-semibold text-secondary mt-4 mb-2">Deskripsi Produk</h5>
                    <p class="text-muted lh-lg" style="text-align: justify;"><?php echo e($raket->deskripsi); ?></p>
                        ...
                        <div class="col-md-5">
                            <div class="d-flex flex-column gap-2 mb-4">
                                <div class="d-flex justify-content-between border-bottom pb-1">
                                    ...
                                    <span class="fw-bold text-dark"><?php echo e($raket->power); ?>/100</span>
                                </div>
                                <div class="d-flex justify-content-between border-bottom pb-1">
                                    <span class="text-muted small"><i class="fa-solid fa-bullseye text-success me-2"></i>Control</span>
                                    <span class="fw-bold text-dark"><?php echo e($raket->control); ?>/100</span>
                                </div>
                                <div class="d-flex justify-content-between border-bottom pb-1">
                                    <span class="text-muted small"><i class="fa-solid fa-gauge-high text-primary me-2"></i>Speed</span>
                                    <span class="fw-bold text-dark"><?php echo e($raket->speed); ?>/100</span>
                                </div>
                                <div class="d-flex justify-content-between border-bottom pb-1">
                                    <span class="text-muted small"><i class="fa-solid fa-shield text-warning me-2"></i>Durability</span>
                                    <span class="fw-bold text-dark"><?php echo e($raket->durability); ?>/100</span>
                                </div>
                                <div class="d-flex justify-content-between border-bottom pb-1">
                                    <span class="text-muted small"><i class="fa-solid fa-wave-square text-info me-2"></i>Flexibility</span>
                                    <span class="fw-bold text-dark"><?php echo e($raket->flexibility); ?>/100</span>
                                </div>
                            </div>

                            <div class="row g-2">
                                <div class="col-6">
                                    <form action="<?php echo e(route('user.pdf', $raket->id)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                ...
                                <div class="col-6">
                                    <form action="<?php echo e(route('user.beli', $raket->id)); ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin membeli raket ini? Produk akan dihapus dari katalog setelah sukses dibeli.')">
                                        <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [<?php echo e($raket->power); ?>, <?php echo e($raket->control); ?>, <?php echo e($raket->speed); ?>, <?php echo e($raket->durability); ?>, <?php echo e($raket->flexibility); ?>],
...
</html><?php /**PATH D:\tugas dio\SMT 4\pem web lanjut\proyek uas\raket-badminton\resources\views/user/show.blade.php ENDPATH**/ ?>
...
<body>
    ...
    <table style="width: 100%; border: none;">
        <tr>
            <td style="width: 60%; vertical-align: top; border: none;">
                <span class="brand-badge"><?php echo e($raket->brand); ?></span>
                <h3 style="margin: 10px 0 5px 0; font-size: 20px; color: #222;"><?php echo e($raket->nama_raket); ?></h3>
            ...
            <td style="width: 40%; text-align: right; vertical-align: top; border: none;">
                <?php if($raket->gambar && file_exists(public_path('storage/' . $raket->gambar))): ?>
                    <img src="<?php echo e(public_path('storage/' . $raket->gambar)); ?>" style="width: 150px; max-height: 180px; border: 1px solid #eee; padding: 5px; border-radius: 8px;">
                <?php endif; ?>
            </td>
        </tr>
    </table>
        ...
        <tr>
            <td style="width: 50%; vertical-align: middle; border: none;">
                <table class="table-spec" style="width: 100%;">
                    ...
                    <tbody>
                        <tr><td><strong>Power</strong></td><td><?php echo e($raket->power); ?> / 100</td></tr>
                        <tr><td><strong>Control</strong></td><td><?php echo e($raket->control); ?> / 100</td></tr>
                        <tr><td><strong>Speed</strong></td><td><?php echo e($raket->speed); ?> / 100</td></tr>
                        <tr><td><strong>Durability</strong></td><td><?php echo e($raket->durability); ?> / 100</td></tr>
                        <tr><td><strong>Flexibility</strong></td><td><?php echo e($raket->flexibility); ?> / 100</td></tr>
                    </tbody>
                </table>
            </td>
            <td style="width: 50%; text-align: center; vertical-align: middle; border: none;">
                <div class="chart-box">
                    <img src="<?php echo e($chartUrl); ?>" style="width: 250px; height: 250px;">
                </div>
            </td>
        </tr>
    </table>
    ...
    <div style="margin-top: 40px; text-align: center; font-size: 11px; color: #999;">
        Dokumen ini dihasilkan secara otomatis oleh sistem komputer SmashZone pada tanggal <?php echo e(date('d-m-Y')); ?>.
    </div>

</body>
</html><?php /**PATH D:\tugas dio\SMT 4\pem web lanjut\proyek uas\raket-badminton\resources\views/user/pdf.blade.php ENDPATH**/ ?>